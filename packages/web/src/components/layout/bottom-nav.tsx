  ...
  return (
    <>
      <div className="fixed left-0 right-0 bottom-[calc(3.4rem+env(safe-area-inset-bottom,0px))] z-40 pointer-events-none">
        <div className="mx-auto max-w-lg px-2 text-center text-[10px] leading-tight text-subtle-foreground">
          {BUILD_FOOTER_TEXT} Build : {BUILD_NUMBER}
        </div>
      </div>
      <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-card/90 backdrop-blur-sm safe-area-bottom">
